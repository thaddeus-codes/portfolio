        ...
        <Carousel id="projects-carousel">
          <Carousel.Item>
            <a href="https://siqbeets.com">
              <img
                src="/images/siq_beets.gif"
                alt="siq beets web application"
          ...
          <Carousel.Item>
            <a href="https://github.com/thaddeus-codes/kanji-flashcards">
              <img
                src="/images/Kanji-flashcards.gif"
                alt="kanji flashcards"
                className="d-block w-100"
              />
              <Carousel.Caption>
                <h1 style={{ color: "black" }}>Kanji Flashcards</h1>
              </Carousel.Caption>
            </a>
          </Carousel.Item>
          <Carousel.Item>
            <a href="https://github.com/thaddeus-codes/Sockets-E-Commerce">
              <img
                src="/images/sockets.gif"
                alt="placeholder"
                className="d-block w-100"
              />
              <Carousel.Caption>
                {" "}
                <h1 style={{ color: "black" }}>Sockets E-Commerce</h1>
              </Carousel.Caption>
            </a>
          </Carousel.Item>
        </Carousel>
